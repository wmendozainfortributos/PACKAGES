--------------------------------------------------------
--  DDL for Package Body PKG_MG_MIGRACION_CARTERA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "GENESYS"."PKG_MG_MIGRACION_CARTERA" as
  ...
  begin
    ...
    for c_impsto in (select max(id_intrmdia) id_intermdia,
                       ...
                       from migra.mg_g_intermedia_ipu_cartera z
      ...
      begin
        update migra.mg_g_intermedia_ipu_cartera z
  ...
  begin
    ...
    /*      insert into gf_g_movimientos_financiero
              select sq_gf_g_movimientos_financiero.nextval as id_mvmnto_fncro
                   , a.*
                from (
                          select a.cdgo_clnte
                               , a.id_impsto
                            ...
                            from (
                                    select z.cdgo_clnte
                                         , z.clmna18 as id_impsto
                                         , z.clmna19 as id_impsto_sbmpsto
                                         , z.clmna24 as id_sjto_impsto
                                         , z.clmna4 as vgncia
                                         , z.clmna21 as id_prdo
                                         , nvl( z.clmna11 , 'ANU' ) as cdgo_prdcdad
                                         , z.clmna25 as cdgo_mvmnto_orgn
                                         , z.clmna26 as id_orgen
                                         , decode( z.clmna10 , 'CV' , 'CN' , z.clmna10 ) as cdgo_mvnt_fncro_estdo
                                      from migra.mg_g_intermedia_ipu_cartera z
                                     where z.id_entdad = p_id_entdad --z.clmna30  = p_id_entdad
                                       and z.clmna24 is not null
                                  group by z.cdgo_clnte
                                         , z.clmna18
                                         , z.clmna19
  ...
  begin
    ...
    for c_carteras in (select /*+ RESULT_CACHE */
                       ...
                       ,
                        ...
                        case
                          when (to_number(z.clmna7) - to_number(z.clmna8)) > 0 then
                       ...
                       /*     ( select x.id_mvmnto_fncro
                                         from gf_g_movimientos_financiero x
                                        where x.cdgo_mvmnto_orgn = a.cdgo_mvmnto_orgn
                                          and x.id_orgen         = a.id_orgen ) as id_mvmnto_fncro
                                   , a.cdgo_mvmnto_orgn
                                   , a.id_orgen
                                   , decode( a.id_cncpto , a.id_cncpto_csdo , 'IN' , 'IT' ) as cdgo_mvmnto_tpo
                                   , a.vgncia
                                   , a.id_prdo
                                   , a.cdgo_prdcdad
                                   , sysdate as fcha_mvmnto
                                ...
                                from (
                                        select z.cdgo_clnte
                                             ...
                                             , 'LQ' as cdgo_mvmnto_orgn -- z.clmna25 as cdgo_mvmnto_orgn
                                             , l.id_lqdcion as id_orgen -- z.clmna26 as id_orgen
                                             , z.clmna10 as cdgo_mvnt_fncro_estdo
                                             , z.clmna28 as id_cncpto
                                             , z.clmna20 as id_cncpto_csdo
                                             , case when abs(z.clmna7 - z.clmna8) > 0 then
      ...
      update migra.mg_g_intermedia_ipu_cartera
  ...
  begin
    ...
    pkg_mg_migracion_cartera.prc_rg_liquidacion_cartera(p_cdgo_clnte => p_cdgo_clnte,
                                                        p_id_impsto  => p_id_impsto);
  
    pkg_mg_migracion_cartera.prc_mg_actualizar_id_cartera(p_id_entdad  => p_id_entdad,
                                                          p_cdgo_clnte => p_cdgo_clnte);
  
    pkg_mg_migracion_cartera.prc_mg_movimiento_financiero(p_id_entdad  => p_id_entdad,
                                                          p_cdgo_clnte => p_cdgo_clnte);
  
    pkg_mg_migracion_cartera.prc_mg_movimiento_detalle(p_id_entdad => p_id_entdad);
  ...
  begin
    ...
    insert into muerto2
      (N_001, V_001, T_001)
    values
      (11, 'Inicia crear liquidaciones ', SYSTIMESTAMP);
    commit;
    begin
    ...
    for reg in (select min(id_intrmdia) as id_intrmdia,
                  ...
                  from migra.mg_g_intermedia_ipu_cartera a
    ...
    insert into muerto2
      (N_001, V_001, T_001)
    values
      (11, 'Fin crear liquidaciones PREDIAL', SYSTIMESTAMP);
    commit;
  
  end prc_rg_liquidacion_cartera;

end pkg_mg_migracion_cartera; ---- Fin encabezado del Paquete pkg_mg_migracion_cartera
