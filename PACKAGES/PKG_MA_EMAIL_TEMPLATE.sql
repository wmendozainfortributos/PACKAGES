--------------------------------------------------------
--  DDL for Package PKG_MA_EMAIL_TEMPLATE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "GENESYS"."PKG_MA_EMAIL_TEMPLATE" IS
    ...
    **********************************************/
    ...
    /*  Global Header */
    FUNCTION fnc_print_global_header return clob;

    /* Global CSS */
    FUNCTION fnc_print_global_css return clob;
    ...
    /* Email Footer */
    FUNCTION fnc_print_global_end return clob;
    ...
    */
    FUNCTION fnc_print_expander return clob;
    ...
    **********************************************/
    ...
    FUNCTION fnc_print_default_body_footer(p_footer_links in varchar2)
	return clob;

    FUNCTION fnc_print_global_body(p_content in clob)
	return clob;
