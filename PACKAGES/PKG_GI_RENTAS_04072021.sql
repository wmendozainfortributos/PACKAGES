--------------------------------------------------------
--  DDL for Package PKG_GI_RENTAS_04072021
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "GENESYS"."PKG_GI_RENTAS_04072021" as
	...
	) return g_dtos_cncpto_sncion pipelined;
	...
	function fnc_cl_concepto_preliquidacion(  p_cdgo_clnte 					in number
											...
											) return g_impuesto_acto_conceptos pipelined;
	...
	/*Registra la liquidación de la renta*/   
	...
	/*Aprueba la solicitud de liquidación de renta*/
    ...
    /*Rechaza la solicitud de liquidación de renta*/
    ...
    type t_tipos_adjunto is record ( dscrpcion          varchar2(1000),
    ...
    function fnc_tipos_adjunto (p_cdgo_clnte          in number,
                                ...
                                p_id_impsto_sbmpsto   in number,
                                p_id_impsto_acto      in number)
    return g_tipos_adjunto pipelined;

    -----    
    type t_adjunto_tmno is record ( extncion    v_gi_d_actos_adjnto_tp_frmt.extncion%type, 
                                    tmno_mxmo   number
                                   );    
    ...
    return g_adjunto_tmno pipelined;    
