--------------------------------------------------------
--  DDL for Package PKG_MG_MIGRACION_CARTERA_VHCLO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "GENESYS"."PKG_MG_MIGRACION_CARTERA_VHCLO" as
  ...
  -- Crea liquidaciones para cartera sin liquidación
  procedure prc_rg_liquidacion_cartera(p_cdgo_clnte in number,
                                       p_id_impsto  in number);

end pkg_mg_migracion_cartera_vhclo;
