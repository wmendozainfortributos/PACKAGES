--------------------------------------------------------
--  DDL for Package PKG_MG_MIGRACION_PREDIAL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "GENESYS"."PKG_MG_MIGRACION_PREDIAL" as
...
end pkg_mg_migracion_predial; ---- Fin encabezado del Paquete pkg_mg_migracion_predial
